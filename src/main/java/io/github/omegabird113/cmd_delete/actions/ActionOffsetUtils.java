...
public final class ActionOffsetUtils {
    ...
    public static int getOffset(@NonNull NavAction action) {
        return switch (action) {
            case NAV_LINE_LEFT, SEL_LINE_LEFT, DEL_LINE_LEFT, NAV_WORD_LEFT, SEL_WORD_LEFT, DEL_WORD_LEFT, OVR_NAV_CHAR_LEFT, OVR_DEL_CHAR_LEFT, OVR_SEL_CHAR_LEFT ->
                    OFFSET_LEFT;
            case NAV_LINE_RIGHT, SEL_LINE_RIGHT, DEL_LINE_RIGHT, NAV_WORD_RIGHT, SEL_WORD_RIGHT, DEL_WORD_RIGHT, OVR_DEL_CHAR_RIGHT, OVR_NAV_CHAR_RIGHT, OVR_SEL_CHAR_RIGHT, NONE ->
                    OFFSET_RIGHT;
    ...
    public static boolean isOverrideAction(@NonNull NavAction action) {
        return switch (action) {
            case OVR_NAV_CHAR_LEFT, OVR_DEL_CHAR_LEFT,
                 ...
                 OVR_SEL_CHAR_LEFT, OVR_SEL_CHAR_RIGHT -> true;
            default -> false;
        };
    }
}
