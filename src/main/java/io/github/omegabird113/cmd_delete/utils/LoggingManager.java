...
public final class LoggingManager {
    ...
    @Contract("_, _ -> new")
    public static @NonNull Logger getLoggerFor(final @NonNull String modid, final @NonNull Class<?> clazz) {
    ...
    @Contract("_, _ -> new")
    public static @NonNull Logger getLoggerFor(final @NonNull String modid, final @NonNull Object o) {
