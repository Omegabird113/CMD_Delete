...
- [friendly_keynames.md](friendly_keynames.md) - a list of every possible friendly keyname alongside it's corresponding raw GLFW keycode and SDL3 scancode
- [jvm_arguements.md](jvm_arguements.md) - a list of every single JVM argument that effects the mod's behavior
